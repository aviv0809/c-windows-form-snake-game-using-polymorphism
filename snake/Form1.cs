...
//we need to separate the function into classes:snake class,circle class and squar class that inherit from shape class(now called circle class),
//also we need to make a apple class and a poisend apple class that will inherit from circle class that will have a negativ and positive affect(like poisend apple will make you faster and apple will make you slower)
//we also need to make a save and load file
namespace snake
{
    public partial class Form1 : Form
    {
        ...
        private void updateGraphics(object sender, PaintEventArgs e)
        {
            ...
            if (Setting.GameOver == false)
            {
                ...
                for (int i = 0; i < Snake.Count; i++)
                {
                    ...
                    canvas.FillEllipse(snakeColour,new Rectangle(Snake[i].X * Setting.Width,Snake[i].Y * Setting.Height,
                    Setting.Width, Setting.Height));

                    // draw food
                    canvas.FillEllipse(Brushes.Red,new Rectangle(food.X * Setting.Width,food.Y * Setting.Height,
                    Setting.Width, Setting.Height));
                }
            }
            else
        ...
        private void startGame()
        {
            ...
            label2.Text = Setting.Score.ToString(); // show the score to the label 2

            generateFood(); // run the generate food function
        }

        private void movePlayer()//should be in snake class
        {
        ...
        private void generateFood()//should be in shape class
        {
        ...
        private void eat()//should be in snake class
        {
            // add a part to body
            ...
            Setting.Score += Setting.Points; // increase the score for the game
